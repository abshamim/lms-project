            ...
            <tr>
                ...
                <td class="border px-4 py-2 ">
                    @foreach ($role->permissions as $permission)
                        <span class="mb-1 inline-block text-white px-1 py-[2px] bg-fuchsia-500 rounded">{{ $permission->name }}</span>
                    @endforeach
                </td>
                <td class="border px-4 py-2 text-center">
                    <div class="flex items-center justify-center">
                        <a class="bg-indigo-600 p-2 rounded-[50px] text-white" href="{{ route('role.edit', $role->id) }}">
